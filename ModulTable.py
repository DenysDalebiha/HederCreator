...
markers = {'РЕЦЕПЦІЯ', 'КAФЕ', 'ПТ', 'KFC', 'ТРЦ', 'ІД', 'ФОП', 'ТОВ', 'ПУНКТ', 'ПНФП', 'ОФІС', 'СКЛАД', 'ШВЕЙНА',
           'БАР', 'АВТОМИЙКА', 'ГЛОБУС', 'АРКАДІЯ', 'ПАРКУВАННЯ', 'ЮРИДИЧНА', 'АДРЕСА', 'КРАМНИЦЯ', 'ЄДРПОУ', 'ЕДРПОУ',
           'МАГАЗИН', 'МАГ-Н', 'КАФЕТЕРІЙ', 'ВІДДІЛЕННЯ', 'ВИЇЗНА', 'САЛОН', 'КОМПЛЕКС', 'ЦЕНТР', 'КЛІНІКА', 'КАСА',
           'ЄДРПОУ', 'СУПЕРМАРКЕТ', 'ГІПЕРМАРКЕТ', 'СКЛАД-ТЕРМІНАЛ', 'АВТОСАЛОН', 'ЧЕРРІ', 'ЗАКУСОЧНА', 'СЕРВІСНИЙ',
           'УКРПОШТА', 'РЕСТОРАН', 'ПН411350026567', 'VIVAT'}
